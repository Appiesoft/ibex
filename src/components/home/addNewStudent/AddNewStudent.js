                            ...
                            <fieldset>
                              ...
                              <Row className="my-3 me-2">
                                <Col className="d-flex justify-content-end">
                                  <button
                                    className="p-2 bg-cyan-500 text-white rounded-1 text-lg font-bold px-3"
                                  >
                                    Save
                                  </button>
                                  <button
                                    className="p-2 bg-cyan-500 text-white rounded-1 text-lg ms-2 font-bold"
                                  >
                                    {`Step ${currentStep} `}
