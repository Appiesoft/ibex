  ...
  return (
    ...
    >
      ...
      <Form.Group  md="4" controlId="validationCustom01">
        ...
        <Form.Label className='mt-3'><b>User Role:</b></Form.Label>
      ...
      <Form.Label className='mt-3'><b>Represent Country:</b></Form.Label>
      ...
      <Form.Label className='mt-3'><b>Login Ability:</b></Form.Label>
      <Form.Group className="mb-3 d-flex">
        <Form.Check
          required
          label="Yes"
      ...
      <Form.Group  md="4" controlId="validationCustom01" className='border-top'>
      ...
      <Modal.Footer>
        <button className='bg-slate-200 px-3 py-2 rounded' onClick={props.onHide}>Cancel</button>
